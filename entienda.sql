...
INSERT INTO users (user, name, surname, password, email, birthdate, admin) VALUES ('rot', 'Alejandro', 'Plutonio', md5('enti'), 'ale@jandro.com', '0000-00-01', false);
...
VALUES ('Grupo04', 2, 2021, 10), ('Grupo01', 2, 2021, 10);

INSERT INTO developers_groups (id_developer, id_group)
VALUES (1,1);

INSERT INTO products (product, description, price, reference, discount, units_sold, website, `size`, duration, release_date, id_group, id_engine_version) VALUES ("Parade", "Consigue mas instrumentos para tu grupo", 1.99, "X1234567", 0, 0, "www.Parade.com", 10, 5, "2021-10-27", 1, 2);

INSERT INTO products (product, description, price, reference, discount, units_sold, website, `size`, duration, release_date, id_group, id_engine_version) VALUES ("BombENTI", "Consigue mas bombas que tus openentes y acaba con ellos", 0.99, "X7654321", 0, 0, "www.BombENTI.com", 7, 2, "2021-02-15", 2, 1);
