...
if(!isset($_POST["user"]) || !isset($_POST["name"]) || !isset($_POST["surnames"]) || !isset($_POST["email"]) || !isset($_POST["birthdate"]) || !isset($_POST["pass"]) || !isset($_POST["repass"])){
...
if(!$res){
	echo "ERROR 11: Query mal formada";
	exit(10);
}
